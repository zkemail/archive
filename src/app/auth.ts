...
export const authOptions = {
  providers: [
    GoogleProvider({
      clientId:
        `${process.env.IS_PULL_REQUEST == 'true' ? process.env.PREVIEW_GOOGLE_CLIENT_ID : process.env.GOOGLE_CLIENT_ID}` ||
        '',
      clientSecret:
        `${process.env.IS_PULL_REQUEST == 'true' ? process.env.PREVIEW_GOOGLE_CLIENT_SECRET : process.env.GOOGLE_CLIENT_SECRET}` ||
        '',
      authorization: {
        params: {
          prompt: 'consent',
